...
public interface StudentDao extends JpaRepository<Student, Long> {
    ...
    @Query("SELECT student from Student student where student.niveau.id_Niveau=:id_niveau and student.filiere.id_filiere=:id_fil")
    ...
    @Query("SELECT student from Student student where student.filiere.id_filiere=:id_fil")
